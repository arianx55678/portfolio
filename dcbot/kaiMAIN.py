...
@bot.event
async def on_ready():
    await bot.change_presence(activity=discord.Game('XINYI\'s pussy'))
    print('fffffffff')
...
async def kg(ctx: commands.Context):
    ...
    instagran_button_kai = ViewButton(style=discord.ButtonStyle.primary, label='', url='https://instagram.com/hsiang_0130?igshid=OGQ5ZDc2ODk2ZA==', emoji='<:ryan_coin:860597363402735616>')
    menu.add_button(instagran_button_kai)
    instagran_button_xinyi = ViewButton(style=discord.ButtonStyle.primary, label='', url='https://instagram.com/fyy._.03?igshid=OGQ5ZDc2ODk2ZA==', emoji='<:unknown2:970260435863470100>')
